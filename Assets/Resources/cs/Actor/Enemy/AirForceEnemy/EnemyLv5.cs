...
public class EnemyLv5 : AirForceEnemy
{
    ...
    IEnumerator AttackModelA()
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            {
                GameObject go = SystemManager.Instance.GetCurrentSceneT<InGameScene>().BulletSystem.ServeBullet(attackModelInfos[0]._bulletCode, bulletSpawnPosition[0].position);
    ...
    IEnumerator AttackModelB()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                GameObject go = SystemManager.Instance.GetCurrentSceneT<InGameScene>().BulletSystem.ServeBullet(attackModelInfos[1]._bulletCode, bulletSpawnPosition[0].position);
    ...
    IEnumerator AttackModelC()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            for (int j = 0; j < 2; j++)
            {
                GameObject go = SystemManager.Instance.GetCurrentSceneT<InGameScene>().BulletSystem.ServeBullet(attackModelInfos[2]._bulletCode, bulletSpawnPosition[j + 1].position);
    ...
    IEnumerator AttackModelD()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            for (int j = 0; j < 2; j++)
            {
                GameObject go = SystemManager.Instance.GetCurrentSceneT<InGameScene>().BulletSystem.ServeBullet(attackModelInfos[3]._bulletCode, bulletSpawnPosition[j + 3].position);
    ...
    IEnumerator UnAvoidableAttack()
    {
        ...
        {
            GameObject go = SystemManager.Instance.GetCurrentSceneT<InGameScene>().BulletSystem.ServeBullet(BulletCode.enemyBulletM2, bulletSpawnPosition[0].position);
