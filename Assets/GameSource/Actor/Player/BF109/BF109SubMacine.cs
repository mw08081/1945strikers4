...
public class BF109SubMacine : MonoBehaviour
{
    ...
    {
        float xDiff = GameManager.Instance.GetCurrentSceneT<InGameScene>().Player.transform.position.x;
        float zDiff = GameManager.Instance.GetCurrentSceneT<InGameScene>().Player.transform.position.z + 3;
        float distance = 0;
