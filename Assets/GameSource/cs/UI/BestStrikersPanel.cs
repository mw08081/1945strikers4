...
public class BestStrikersPanel : MonoBehaviour
{
    ...
    {
        int player1ScoreTmp = GameManager.Instance.ScoreSystem.Player1Score;
        ...
        if (PlayerPrefs.GetInt("5thScore") <= player1ScoreTmp)
        {
            for (int i = 0; i < 5; i++)
            {
                if (PlayerPrefs.GetInt(keyArr[2, i]) <= player1ScoreTmp)
                {
                    ...
                    PlayerPrefs.SetString(keyArr[1, i], playerModel[GameManager.Instance.Player1PrefabIndex]);
        ...
        if (GameManager.Instance.isForDos && (PlayerPrefs.GetInt("5thScore") <= GameManager.Instance.ScoreSystem.Player2Score))
        {
            int player2ScoreTmp = GameManager.Instance.ScoreSystem.Player2Score;
            ...
            for (int i = 0; i < 5; i++)
            {
                if (PlayerPrefs.GetInt(keyArr[2, i]) <= player2ScoreTmp)
                {
                    ...
                    PlayerPrefs.SetString(keyArr[1, i], playerModel[GameManager.Instance.Player2PrefabIndex]);
